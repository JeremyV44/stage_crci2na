...
def load_files():
    ...
    fichier_pickle = ctk.filedialog.askopenfilename(title="Sélectionner le fichier pickle")
    dossier_output = ctk.filedialog.askdirectory(title="Sélectionner le dossier de sortie")
...
fichier_pickle_label = ctk.CTkLabel(parameter_frame, text="Fichier pickle:")
...
fichier_pickle_button = ctk.CTkButton(parameter_frame, text="Parcourir...", command=load_files)
fichier_pickle_button.grid(row=1, column=2, padx=5, pady=5)

dossier_output_label = ctk.CTkLabel(parameter_frame, text="Nom du dossier de sortie:")
...
dossier_output_button = ctk.CTkButton(parameter_frame, text="Parcourir...", command=load_files)
dossier_output_button.grid(row=2, column=2, padx=5, pady=5)

liste_genes_label = ctk.CTkLabel(parameter_frame, text="Liste des gènes (ou nombre):")
