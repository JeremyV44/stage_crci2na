...
- La deuxième colonne s'appelle "Condition" et tout doit être séparé par des underscores "_".

## Utilisation

Déplacez dans le dossier où le code se situe, pour cela vous pouvez utilisez la commande `cd`
